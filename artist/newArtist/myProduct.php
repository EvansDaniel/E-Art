...
<html>
	...
	<head>
		...
		<script>
          ...
          ?> 
			...
			function preload(){
 			...
 			$(document).ready(function() {
      		...
      		//document.getElementById("nav6").setAttribute("style","visibility: hidden");
      	...
      	//document.getElementById("nav6").setAttribute("style","visibility: visible");
